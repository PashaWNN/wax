...
```
### Как это выглядит
[Режим сервера](https://github.com/PashaWNN/wax/blob/master/docs/web.png "Server mode")
[Режим терминала](https://github.com/PashaWNN/wax/blob/master/docs/terminal.png "Terminal mode")
